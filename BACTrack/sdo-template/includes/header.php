    ...
    <div class="admin-layout">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <div class="logo">
                    <img src="<?php echo rtrim(APP_URL ?? '/BACTrack', '/'); ?>/sdo-template/logo-imgs/sdo-logo.jpg" alt="SDO San Pedro Logo" class="logo-img" style="width:50px;height:50px;object-fit:cover;clip-path:circle(70% at 50% 50%);background-color:transparent;mix-blend-mode:multiply;">
                    <div class="logo-text">
