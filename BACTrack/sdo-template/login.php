    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                <div class="logo-badge"><img src="<?php echo rtrim(APP_URL ?? '/BACTrack', '/'); ?>/sdo-template/logo-imgs/sdo-logo.jpg" alt="SDO San Pedro Logo" style="width:90px;height:90px;object-fit:cover;clip-path:circle(70% at 50% 50%);background-color:transparent;mix-blend-mode:multiply;"></div>
                <h1>SDO CTS Admin</h1>
