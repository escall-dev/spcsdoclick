        ...
        <div class="profile-header">
            <div class="avatar-section">
                ...
                <button type="button" class="avatar-edit-btn"
                    onclick="document.getElementById('avatarModal').classList.add('show')">
    ...
    <div class="avatar-modal-content">
        <div class="avatar-modal-header">
            ...
            <button type="button" class="modal-close-btn"
                onclick="document.getElementById('avatarModal').classList.remove('show')">
        ...
        <div class="avatar-preview-section">
            <?php if (!empty($user['avatar_url'])): ?>
                <img src="<?php echo htmlspecialchars($user['avatar_url']); ?>" alt="Current Avatar" class="avatar-preview"
                    id="avatarPreview">
            <?php else: ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data" id="avatarForm">
            ...
            <input type="file" name="avatar" id="avatarInput" class="avatar-file-input"
