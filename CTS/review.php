...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Playfair+Display:wght@600;700&family=JetBrains+Mono:wght@500;700&display=swap"
        rel="stylesheet">
...
<body>
    <div class="container">
        ...
        <?php if ($isHandwritten): ?>
            <div class="no-print"
                style="background:#1b4a9a;color:#ffffff;padding:15px;border-radius:8px;margin-bottom:20px;border:1px solid #1b4a9a;">
        ...
        <div class="review-banner no-print"
            ...
            <span class="icon" style="font-size: 1.5rem; margin-bottom: 1px;"><i
                                ...
                                <li class="doc-item">
                                    <div class="doc-info">
                                        <i class="fas <?php echo $iconClass; ?>"
                                            style="font-size:24px;color:<?php echo $iconColor; ?>;flex-shrink:0;"></i>
                                        <div style="min-width:0;">
                                            <div
                                                style="font-weight:500;color:#1f2937;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:300px;">
                                    ...
                                    <div class="doc-actions">
                                        <button type="button" class="btn btn-sm btn-outline doc-modal-btn"
                                            data-url="<?php echo htmlspecialchars($url); ?>" data-type="<?php echo $docType; ?>"
                                            data-name="<?php echo htmlspecialchars($fileName); ?>" title="View in popup">
                                            <i class="fas fa-expand"></i> View
                                        </button>
                                        <button type="button" class="btn btn-sm btn-outline doc-print-btn"
                                            data-url="<?php echo htmlspecialchars($url); ?>" data-type="<?php echo $docType; ?>"
                                            data-name="<?php echo htmlspecialchars($fileName); ?>"
                                            data-category="<?php echo htmlspecialchars($file['category'] ?? 'supporting'); ?>"
                                            title="Print">
                                            <i class="fas fa-print"></i>
                                        </button>
                                        <a href="<?php echo htmlspecialchars($url); ?>"
                                            download="<?php echo htmlspecialchars($fileName); ?>" class="btn btn-sm btn-primary"
                                            title="Download" style="color:#fff !important;">
                                            <i class="fas fa-download" style="color:#fff;"></i> <span
                                ...
                                <li class="doc-item">
                                    ...
                                    <div class="doc-actions">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline doc-print-btn"
                                            data-url="<?php echo htmlspecialchars($url); ?>" data-type="<?php echo $docType; ?>"
                                            data-name="<?php echo htmlspecialchars($fileName); ?>"
                                            data-category="<?php echo htmlspecialchars($file['category'] ?? 'valid_id'); ?>"
                                            title="Print">
                                            <i class="fas fa-print"></i>
                                        </button>
                                        <a href="<?php echo htmlspecialchars($url); ?>"
        ...
        <?php else: ?>
            ...
            <div class="form-container">
                ...
                <img src="reference/COMPLAINT-ASSISTED-FORM_1.jpg" alt="Complaint Assisted Form" class="form-background">
                ...
                <div class="form-overlay">
                    ...
                    <div class="field-box complainant-name-box">
                        <?php echo htmlspecialchars($data['name_pangalan'] ?? ''); ?></div>
                    <div class="field-box complainant-address-box">
                        <?php echo htmlspecialchars($data['address_tirahan'] ?? ''); ?></div>
                    <div class="field-box complainant-contact-box">
                        <?php echo htmlspecialchars($data['contact_number'] ?? ''); ?></div>
                    <div class="field-box complainant-email-box">
                        <?php echo htmlspecialchars($data['email_address'] ?? ''); ?></div>

                    <!-- Involved Person/Office -->
                    <div class="field-box involved-name-box">
                        <?php echo htmlspecialchars($data['involved_full_name'] ?? ''); ?></div>
                    <div class="field-box involved-position-box">
                        <?php echo htmlspecialchars($data['involved_position'] ?? ''); ?></div>
                    <div class="field-box involved-address-box">
                        <?php echo htmlspecialchars($data['involved_address'] ?? ''); ?></div>
                    <div class="field-box involved-school-box">
                        <?php echo htmlspecialchars($data['involved_school_office_unit'] ?? ''); ?></div>

                    <!-- Narration (Multi-line, Controlled) -->
                    <div class="field-box narration-box"><?php echo htmlspecialchars($data['narration_complaint'] ?? ''); ?>
                    </div>

                    <!-- Signature -->
                    <div class="field-box signature-box">
                        <?php echo htmlspecialchars($data['typed_signature'] ?? ($data['name_pangalan'] ?? '')); ?></div>

                </div>
            </div>
            <div class="page-indicator no-print">Page 1 of
                <?php echo !empty($data['narration_complaint_page2']) ? '2' : '1'; ?></div>
            ...
            <?php if (!empty($data['narration_complaint_page2'])): ?>
                <div class="additional-page">
                    ...
                    <div class="additional-page-content"><?php echo htmlspecialchars($data['narration_complaint_page2']); ?>
                    </div>
                </div>
        ...
        <form method="POST" class="no-print" id="submitForm">
            ...
            <?php if ($needsComplainantInfo): ?>
                ...
                <section class="form-section"
                    style="margin-top:20px; border: 2px solid var(--warning-color); background: #fff8e6;">
                    ...
                    <div class="section-content">
                        <div style="margin-bottom: 1.5rem; color: #92400e;">
                            <p style="margin: 0;"><strong><i class="fas fa-info-circle"></i> Important:</strong> Since you
                                uploaded a completed form, please provide your contact information so we can send you
                                confirmation and updates about your complaint.</p>
                        </div>
                        ...
                        <div class="bypass-contact-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="bypass_name" name="bypass_name"
                                    placeholder="Your full name"
                                    value="<?php echo htmlspecialchars($data['name_pangalan'] ?? ''); ?>" required>
                                <div class="field-error" id="bypassNameError"
                                    style="color: #dc2626; font-size: 0.875rem; margin-top: 0.5rem; display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="bypass_email" name="bypass_email"
                                    placeholder="your@email.com"
                                    value="<?php echo htmlspecialchars($data['email_address'] ?? ''); ?>" required>
                                <div class="field-error" id="bypassEmailError"
                                    style="color: #dc2626; font-size: 0.875rem; margin-top: 0.5rem; display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="bypass_contact" name="bypass_contact"
                                    placeholder="09171234567"
                                    value="<?php echo htmlspecialchars($data['contact_number'] ?? ''); ?>" required>
                                <div class="field-error" id="bypassContactError"
                                    style="color: #dc2626; font-size: 0.875rem; margin-top: 0.5rem; display: none;">
                        ...
                        <div style="margin-top: 1.5rem;">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="bypass_unit" name="bypass_unit" required
                                    style="max-width: 100%;">
                                    ...
                                    <option value="Admin" <?php echo ($data['involved_school_office_unit'] ?? '') === 'Admin' ? 'selected' : ''; ?>>Admin: Cash, Personnel, Records, Supply, General Services,
                                        Procurement</option>
                                    <option value="CID" <?php echo ($data['involved_school_office_unit'] ?? '') === 'CID' ? 'selected' : ''; ?>>CID: Curriculum Implementation Division (LRMS, Instructional
                                        Management, PSDS)</option>
                                    ...
                                    <option value="SGOD" <?php echo ($data['involved_school_office_unit'] ?? '') === 'SGOD' ? 'selected' : ''; ?>>SGOD: School Governance and Operations Division (M&E, SocMob,
                                        Planning & Research, HRD, Facilities, School Health)</option>
                                </select>
                                <div class="field-error" id="bypassUnitError"
                                    style="color: #dc2626; font-size: 0.875rem; margin-top: 0.5rem; display: none;">
                                    <i class="fas fa-exclamation-circle"></i> Please select the unit/office for this
                                    complaint.
                                </div>
                                <small style="color: #78716c; margin-top: 0.5rem; display: block;">Select the unit/office
                                    where your complaint should be directed.</small>
                            </div>
                        </div>
                    </div>
                </section>
            <?php else: ?>
                ...
                <section class="form-section" style="margin-top:20px; background: #ffffff; border: 1px solid #1b4a9a;">
                    <div class="section-header"
                        style="background: #1b4a9a; border: none; color: #ffffff; padding: 12px 15px;">
                    ...
                    <div class="section-content">
                        <table class="complainant-info-table" style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <td
                                    style="padding: 10px 12px; border-bottom: 1px solid #1b4a9a; background: #ffffff; color: #1b4a9a; width: 25%;">
                            ...
                            <tr>
                                <td
                                    style="padding: 10px 12px; border-bottom: 1px solid #1b4a9a; background: #ffffff; color: #1b4a9a;">
                            ...
                            <tr>
                                <td style="padding: 10px 12px; background: #ffffff; color: #1b4a9a;"><strong>Complaint
                                        Recipient:</strong></td>
            ...
            <div class="form-actions" style="margin-top:20px;">
                ...
                <div class="review-action-group" style="display:flex;gap:10px;">
                    <button type="submit" name="confirm_submit" class="btn btn-success btn-lg" id="submitBtn">
                        ✅ Confirm & Submit
                    </button>
                </div>
            </div>
                ...
                <div class="doc-modal-header">
                    ...
                    <div class="doc-modal-actions">
                        <div id="modalZoomToolbar" style="display:flex;align-items:center;gap:6px;margin-right:12px;">
                            ...
                            <button type="button" class="btn btn-sm btn-outline" data-zoom="out"
                                title="Zoom out">−</button>
                            <button type="button" class="btn btn-sm btn-outline" data-zoom="in"
                                title="Zoom in">+</button>
                            <button type="button" class="btn btn-sm btn-secondary" data-zoom="reset"
                    ...
                    if (type === 'image') {
                        ...
                        <body>
                            <div class="print-header">
                                <img src="assets/img/sdo-logo.jpg" alt="SDO Logo" class="sdo-logo">
                                <div>
                                    <div class="print-title">Schools Division office of San Pedro City</div>
                                    <div class="print-subtitle">${categoryLabel}</div>
                                </div>
                                <img src="assets/img/bagongpilpinas-logo.png" alt="Bagong Pilipinas">
                            </div>
